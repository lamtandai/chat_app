...
stompClient.onConnect = (frame) => {
    ...
    stompClient.subscribe('/topic/rankings', (greeting) => {
        ...
        message = "<tr><td>Name</td><td>Score</td></tr>";
        for (let i = 0; i < body.length; i++) {
            message += "<tr><td>" + body[i].name + "</td><td>" + body[i].score + "</td></tr>";
        }
...
function updateScore() {
    ...
    $.ajax({
        type: 'POST',
        url: '/test/update-ranking', // Specify the URL where you want to send the request
